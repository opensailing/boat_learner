defmodule ReinforcementLearning.Agent do
  @moduledoc """
  The behaviour that should be implemented by a `ReinforcementLearning` agent module.
  """

  @typedoc "An arbitrary `Nx.Container` that holds metadata for the agent"
  @type t :: Nx.Container.t()
  @type rl_state :: ReinforcementLearning.t()
